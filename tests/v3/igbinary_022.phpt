...
test('autoload', '0000000317034f626a140211016106011101620602', false);
test('autoload', '0000000317034f626b140211016106011101620602', false);
ini_set('unserialize_callback_func', strtolower('Missing_autoload'));
test('missing_autoload', '0000000317034f626c140211016106011101620602', false);
