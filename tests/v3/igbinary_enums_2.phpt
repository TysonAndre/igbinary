...
?>
--EXPECTF--
\x00\x00\x00\x03\x19\x02\x0E\x06Hearts\x22\x1C\x04Suit\x23\x12\x00\x04\x01\x22\x24\x01
array(2) {
  ["Hearts"]=>
  &enum(Suit::Hearts)
  [1]=>
...
Warning: igbinary_unserialize_v3_object_enum_case: Suit::HEARTS is not an enum case in %s on line 25
NULL

Warning: igbinary_unserialize_v3_object_enum_case: Undefined constant Suit::vvvvvv in %s on line 28
NULL

Warning: igbinary_unserialize_v3_object_enum_case: Class 'Club' does not exist in %s on line 31
NULL

Warning: igbinary_unserialize_v3_object_enum_case: Class 'ABCD' is not an enum in %s on line 34
NULL