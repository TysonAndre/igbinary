...
test('autoload', '0000000317034f626a140211016106011101620602');  // "Obj"
test('autoload', '0000000317034f626b140211016106011101620602');  // "Obk" failing to autoload
ini_set('unserialize_callback_func', strtolower('Missing_autoload'));
test('missing_autoload', '0000000317034f626c140211016106011101620602');  // Obk" with missing autoload function
